...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    BOOL isPresent;
    //判断运动方向
    if (self.animationType == KNavAnimationTypePop) {
        isPresent = YES;
    }else{
        isPresent = NO;
    }
    ...
    for (int i = 0; i<self.folds; i++) {
        ...
        UIView *tempView1 = leftFromViewFold.subviews[1];
        [tempView1 setAlpha:0.0];
        ...
        UIView *tempView2 = rightFromViewFold.subviews[1];
        [tempView2 setAlpha:0.0];
    ...
    [UIView animateWithDuration:duration animations:^{
        ...
        for (int i = 0; i < self.folds; i++) {
            ...
            UIView *tempView1 = leftFromView.subviews[1];
            [tempView1 setAlpha:0.0];
            ...
            UIView *tempView2 = rightFromView.subviews[1];
            [tempView2 setAlpha:0.0];
            ...
            UIView *tempView3 = leftToView.subviews[1];
            [tempView3 setAlpha:0.0];
            ...
            UIView *tempView4 = rightToView.subviews[1];
            [tempView4 setAlpha:0.0];
