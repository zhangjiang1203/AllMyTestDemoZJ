...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"功能选择";
    viewControllerArr = @[@"ZJBaiDuBaseViewController",@"ZJBaseMapViewController",@"ZJPaymentViewController",@"ZJMulScrollViewController",@"ZJCalendarViewController",@"ZJWebOperationViewController",@"ZJOpenFileViewController"];
    titleControllerArr = @[@"百度地图",@"高德地图",@"移动支付",@"多视图滚动",@"自定义日历",@"webView交互",@"应用内预览word，ppt，Excel功能"];
