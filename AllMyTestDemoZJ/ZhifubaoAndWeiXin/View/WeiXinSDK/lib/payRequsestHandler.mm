...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPayWithTitle:(NSString*)title price:(NSString*)price
{

    //订单标题，展示给用户
    NSString *order_name = title;
    NSInteger titPrice = [price floatValue]*100;
    //订单金额,单位（分）
    NSString *order_price   = [NSString stringWithFormat:@"%zd",titPrice];//1分钱测试
